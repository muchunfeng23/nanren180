...
//	@Autowired
//	private ValueOperations<String,OpenIdAndSessionKey> valOps;
	@Autowired
	...
	public String createASession(String openId, String sessionKey) {
		...
		valOps.set(thirdSessionKey,openIdAndSessionKeyJson, 60, TimeUnit.MINUTES);  
	...
	public boolean updateSessionTime(String thirdSession) {
		String fromJson = (String)valOps.get(thirdSession);
		valOps.set(thirdSession,fromJson, 60, TimeUnit.MINUTES);  
		return true;
	}
